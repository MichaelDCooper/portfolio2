    ...
    <div>
      ...
      <div>
        ...
        <p>
          ...
          thorough for my own reference in the future and I want to help anyone
          looking for recommendations, or wondering how I do something. I
          consider most of the equipment listed here a recommendation and as a
          general rule of thumb, I don't recommend anything I haven't used for a
          few months. With that being said my local environment may be slightly
          different from this page as I like to change my setup semi-frequently.
          As soon as a product I've been using proves itself worthy, I'll update
          this page accordingly. PS: If you're using something cool that you
          think I'd like, shoot me an email!
        </p>
        ...
        <ul>
          <li>
            <p>2017 iMac (Do not recommend)</p>
            <p>
              Mostly used for ProTools and music production. In retrospect, I
              should have built a PC. Two years after purchasing this maxed out
              Apple computer I find that it struggles to keep up with modern
              audio plugins. It's also worth noting that the design of the
              screen makes it fairly difficult to pair this machine with a
              secondary monitor. Don't get me wrong, the display is beautiful,
              but in order to turn this into a hybrid code/music production
        ...
        <ul>
          ...
          <li>
            <p>
              C++: XCode/Clion with default Apple Dark Theme/Material UI Theme
            </p>
          </li>
          <li>
            <p>
